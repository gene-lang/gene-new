...
var _gene_result_status = Module['_gene_result_status'] = makeInvalidEarlyAccess('_gene_result_status');
var _gene_result_text_ptr = Module['_gene_result_text_ptr'] = makeInvalidEarlyAccess('_gene_result_text_ptr');
var _gene_result_text_len = Module['_gene_result_text_len'] = makeInvalidEarlyAccess('_gene_result_text_len');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['gene_result_status'] != 'undefined', 'missing Wasm export: gene_result_status');
  assert(typeof wasmExports['gene_result_text_ptr'] != 'undefined', 'missing Wasm export: gene_result_text_ptr');
  assert(typeof wasmExports['gene_result_text_len'] != 'undefined', 'missing Wasm export: gene_result_text_len');
  ...
  _gene_result_status = Module['_gene_result_status'] = createExportWrapper('gene_result_status', 1);
  _gene_result_text_ptr = Module['_gene_result_text_ptr'] = createExportWrapper('gene_result_text_ptr', 1);
  _gene_result_text_len = Module['_gene_result_text_len'] = createExportWrapper('gene_result_text_len', 1);
